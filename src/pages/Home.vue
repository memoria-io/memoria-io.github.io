        ...
        <div class="space-y-8">
          ...
          <div class="bg-white rounded-lg p-6 shadow-sm">
            ...
            <div class="flex gap-4">
              <router-link to="/products" class="inline-flex items-center px-4 py-2 bg-[#3f7fbf] text-white rounded-lg hover:bg-[#2d5d8f] transition-colors">
                View Products
              </router-link>
              <router-link to="/contact" class="inline-flex items-center px-4 py-2 border border-[#3f7fbf] text-[#3f7fbf] rounded-lg hover:bg-[#3f7fbf] hover:text-white transition-colors">
                Contact Us
              </router-link>
            </div>
          </div>
